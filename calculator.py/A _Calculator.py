...
class Calculator:
    def __init__(self,master):
        master.title("Calculator pro")
        master.geometry('357x420+0+0')
        master.config(bg='#9d9dff')

        self.equation=StringVar()
        self.entry_value=''
        Entry(width=17,bg='#ebebff', font=('Arial Bold',28),textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11,height=4,text='=',relief='flat',bg='#4ed3ff',command=self.solve).place(x=270 ,y=350)
